...
//						alert(json);
			...
			for (var i = 0, field_errors = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "max":
						...
						break;
					case "maxid":
						errorMsg = methods._getErrorMessage(form, field, rules[i], rules, i, options, methods._maxid);
						break;
					case "past":
		...
		*/
		...
		_maxid: function(field, rules, i, options) {
			
			var equalsField = rules[i + 1];

			var max_val= $("#" + equalsField).val();
